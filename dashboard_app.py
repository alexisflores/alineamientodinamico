...
# Función para cargar y mostrar cada tablero junto con su OKR y gráfico Matplotlib
...
if st.button("Mostrar Tablero 1: Fortalecer la inteligencia de mercado"):
...
if st.button("Mostrar Tablero 2: Monitorear innovaciones tecnológicas de la competencia"):
...
if st.button("Mostrar Tablero 3: Incrementar la captación de datos externos en mercados clave"):
    ...
    load_dashboard("data_capture_data.csv", okr_3, desc_3, chart_type="pie", x_col="Market", y_col="Coverage_Percentage")

# Tablero 4: Expandir la cartera de productos personalizados
if st.button("Mostrar Tablero 4: Expandir la cartera de productos personalizados"):
...
if st.button("Mostrar Tablero 5: Mejorar la eficiencia en la toma de decisiones de inversión en nuevas tecnologías"):
...
if st.button("Mostrar Tablero 6: Ampliar las colaboraciones estratégicas"):
...
if st.button("Mostrar Tablero 7: Optimizar la estructura organizativa"):
    ...
    load_dashboard("organizational_structure_data.csv", okr_7, desc_7, chart_type="pie", x_col="Subsidiary", y_col="Autonomy_Index")

# Tablero 8: Integrar sistemas digitales para mejorar la colaboración
if st.button("Mostrar Tablero 8: Integrar sistemas digitales para mejorar la colaboración"):
...
if st.button("Mostrar Tablero 9: Fortalecer la cultura de innovación y colaboración"):
